  ...
  switch (funcid) {
    ...
    case SBI_SM_RANDOM:
      *out_val = sbi_sm_random();
      retval = 0;
      break;
    case SBI_SM_GET_VERIFIABLE_NONCE:
      //TODO: Impl this
      *out_val = sbi_sm_random();
      retval = sbi_sm_track_nonce(*out_val);
      break;
    case SBI_SM_VERIFY_NONCE:
      retval = sbi_sm_verify_nonce(regs->a0);
      break;
    ...
    case SBI_SM_CALL_PLUGIN:
      ...
      break;
    case SBI_SM_SET_UNIX_TIME:
      retval = sbi_sm_set_unix_time(regs->a0);
      break;
    case SBI_SM_GET_UNIX_TIME:
      retval = sbi_sm_get_unix_time();
      break;
    default:
